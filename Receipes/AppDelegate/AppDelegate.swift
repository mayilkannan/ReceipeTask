...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var categoryCollectionRef: CollectionReference? = nil
    var recipesCollectionRef: CollectionReference? = nil
    var ingredientsCollectionRef: CollectionReference? = nil
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        categoryCollectionRef = db?.collection("categories")
        recipesCollectionRef = db?.collection("recipes")
...
//        addIngredients()
        ...
        db?.collection("ingredients").getDocuments() { (querySnapshot, err) in
            if let err = err {
                ...
                for document in querySnapshot!.documents {
                    ...
                    allIngredients.append(IngredientModel(ingredientId: data["ingredientId"] as? Int, name: data["name"] as? String, photo_url: data["photo_url"] as? String))
                }
                allIngredients = allIngredients.sorted(by: { $0.ingredientId! < $1.ingredientId! })
            }
        }
    }
    
    func addCategories() {
        addFireStoreCategoriesData(id: 0, name: "Pizza", photo_url: "https://amp.businessinsider.com/images/5c084bf7bde70f4ea53f0436-750-563.jpg")
        addFireStoreCategoriesData(id: 1, name: "Mexican Food", photo_url: "https://ak1.picdn.net/shutterstock/videos/19498861/thumb/1.jpg")
        addFireStoreCategoriesData(id: 2, name: "Italian Food", photo_url: "https://images.unsplash.com/photo-1533777324565-a040eb52facd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80")
        addFireStoreCategoriesData(id: 3, name: "Cookies", photo_url: "https://www.telegraph.co.uk/content/dam/Travel/2019/January/france-food.jpg?imwidth=1400")
        addFireStoreCategoriesData(id: 4, name: "Smoothies", photo_url: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/still-life-of-three-fresh-smoothies-in-front-of-royalty-free-image-561093647-1544042068.jpg?crop=0.715xw:0.534xh;0.0945xw,0.451xh&resize=768:*")
    }
    
    func addReceipes() {
        addFireStoreReceipesData(recipeId: 122,
            categoryId: 3,
    ...
    func addFireStoreCategoriesData(id:Int, name: String, photo_url: String) {
        
        categoryCollectionRef?.addDocument(data: [
            "id": id,
            "name": name,
            "photo_url": photo_url
        ]) { err in
    ...
    func addFireStoreReceipesData(recipeId:Int, categoryId:Int, title: String, photo_url: String, photosArray: [String], time: Int, ingredients: [[String: String]], description: String) {
        
        recipesCollectionRef?.addDocument(data: [
            "recipeId": recipeId,
    ...
    func addFireStoreIngredientsData(ingredientId:Int, name: String, photo_url: String) {
        
        ingredientsCollectionRef?.addDocument(data: [
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Receipes")
